...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Sharkboyz Online Ticketing</a>
    </div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">1. FLIGHT DETAILS
								</h3>
							</div>
							<div class="panel-body">
								SCHEDULE OF TRAVEL
			 ...
			 <h2>
				...
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-pass">
					  ...
					  <div class="form-group">
					    <label for="">Age:</label>
					    <input type="number" class="form-control" id="bage" placeholder="Enter Age" required="" autocomplete="off">
					  </div>
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <input type="text" class="form-control" id="email" placeholder="Enter Email" required="" autocomplete="off">
					  </div>
					  		...
					  		<div class="container-fluid">
								  ...
								  <div class="form-group">
								   ...
								   <div class="form-group">
								    ...
								    <input type="text" class="form-control" id="address<?php echo $i; ?>"
								    placeholder="Enter Address" required autocomplete="off">
									
								  </div>
								    <div class="form-group">
								    <label for="">Contact: (<?= $count; ?>):</label>
								    <input type="number" class="form-control" id="pcont<?php echo $i; ?>"
								    placeholder="Enter Contact #" required autocomplete="off">
								  </div>

								    <div class="form-group">
								    <label for="">Email: (<?= $count; ?>):</label>
								    <input type="text" class="form-control" id="pmail<?php echo $i; ?>"
								    placeholder="Enter Email" required autocomplete="off">
								  </div>
					   <div class="form-group">
					    <label for="">Birth Date:</label>
					    <input type="date" class="btn btn-default" id="birth<?php echo $i; ?>"
						placeholder="Enter Birth" required="" autocomplete="off">
					  </div>
								  <div class="form-group">
...
<script type="text/javascript">
	$(document).on('submit', '#form-pass', function(event) {
		...
		for(var i = 0; i < counter; i++){
			...
			var pcont = $('#pcont'+i).val();
			var pmail = $('#pmail'+i).val();
			var birth = $('#birth'+i).val();
